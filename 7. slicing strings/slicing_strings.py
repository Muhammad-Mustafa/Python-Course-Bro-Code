...
# we can also write [0: 8] but if we dont provide the index python will assume the index is zero
first_name = name[:8]
# we can also write [9:16] but if we dont specify the index python will assume its the last index
last_name = name[9:]
